...
#define BSP_CFG_PLL_MUL BSP_CLOCKS_PLL_MUL(64,0) /* PLL Mul x60-79|Mul x64|PLL Mul x64.00 */
#define BSP_CFG_PLL_FREQUENCY_HZ (640000000) /* PLL 640000000Hz */
#define BSP_CFG_PLODIVP (BSP_CLOCKS_PLL_DIV_16) /* PLL1P Div /16 */
#define BSP_CFG_PLL1P_FREQUENCY_HZ (40000000) /* PLL1P 40000000Hz */
#define BSP_CFG_PLODIVQ (BSP_CLOCKS_PLL_DIV_8) /* PLL1Q Div /8 */
#define BSP_CFG_PLL1Q_FREQUENCY_HZ (80000000) /* PLL1Q 80000000Hz */
...
#define BSP_CFG_I3CCLK_DIV (BSP_CLOCKS_I3C_CLOCK_DIV_8) /* I3CCLK Div /8 */
